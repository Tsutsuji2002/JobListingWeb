...
{
    /// <inheritdoc />
    public partial class DBInit13 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatRooms_AspNetUsers_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatRooms_AspNetUsers_EmployerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitializationVector = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_EmployerId_ApplicantId",
                table: "ChatRooms",
                columns: new[] { "EmployerId", "ApplicantId" },
                unique: true,
                filter: "[EmployerId] IS NOT NULL AND [ApplicantId] IS NOT NULL");
        }
